<?php
namespace Zeo\CheckoutAdditionalFields\Model;
...
{
    const XPATH_FORMAT = 'Zeo_CheckoutAdditionalFields/general/format';
    const XPATH_DISABLED = 'Zeo_CheckoutAdditionalFields/general/disabled';
    const XPATH_HOURMIN = 'Zeo_CheckoutAdditionalFields/general/hourMin';
    const XPATH_HOURMAX = 'Zeo_CheckoutAdditionalFields/general/hourMax';
